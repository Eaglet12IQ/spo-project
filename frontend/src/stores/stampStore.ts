...
export const useStampStore = defineStore('stamps', () => {
  const stamps = ref<Stamp[]>([
    ...
    },
    {
      ...
      image: 'https://images.pexels.com/photos/12605238/pexels-photo-12605238.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    ...
    },
    {
      ...
      image: 'https://images.pexels.com/photos/19102326/pexels-photo-19102326/free-photo-of-vintage-envelopes-and-stamps.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
      country: 'Mauritius',
      year: 1847,
